...
const profiles={
  oriola:{
    ...
    work:[
      {src:'assets/team/oriola-project-1.jpg',caption:'Multi-storey Institutional / Commercial Development — Exterior Visualisation'},
      {src:'assets/team/oriola-project-2.jpg',caption:'Sports Complex — Grandstand and Track Visualisation'},
      {src:'assets/team/oriola-project-3.jpg',caption:'Sports Complex — Covered Spectator Grandstand'},
      {src:'assets/team/oriola-project-4.jpg',caption:'Sports Complex — Basketball and Tennis Courts'},
      {src:'assets/team/oriola-project-5.jpg',caption:'Clubhouse — Exterior Visualisation'}
    ]
  },
  ajayi:{
  ...
  ojelade:{
    name:'Ojelade Oluwasegun',role:'Architectural Designer & Documentation Specialist',credentials:'B.Sc. (Lead City University, 2026), HND, OND (Architecture)',portrait:'assets/team/ojelade-oluwasegun.jpg',initials:'OO',
    ...
    work:[
      {src:'assets/team/ojelade-project-1.jpg',caption:'Contemporary Residential Development — Exterior Visualisation'},
      {src:'assets/team/ojelade-project-2.jpg',caption:'Container Restaurant — Exterior Visualisation'},
      {src:'assets/team/ojelade-project-3.jpg',caption:'Restaurant / Lounge — Interior Visualisation'}
    ]
  }
};
